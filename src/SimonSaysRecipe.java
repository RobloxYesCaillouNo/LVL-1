...
public class SimonSaysRecipe extends KeyAdapter {
	...
	private void makeAlbum() {
		...
		images.put(KeyEvent.VK_UP, "up.png");
		images.put(KeyEvent.VK_DOWN, "down.png");
		images.put(KeyEvent.VK_LEFT, "left.png");
		images.put(KeyEvent.VK_RIGHT, "right.png");
		// 3. Tell the user to "Press the matching key when 'Simon says' otherwise press
		// a different key"
		JOptionPane.showMessageDialog(null, "Press the key when simon says otherwise press a different key");
...
int points = 0;
	public void keyPressed(KeyEvent e) {
		...
		// increase their score
			...
			speak("Get rekt nub, u haz faild! You are incorrect");
		}
	...
	private void showImage() {
		...
		framed.add(getNextRandomImage());
		// 8. set the size of the frame
		framed.setSize(2000, 1000);
		// 9. add a key listener to the frame
		framed.addKeyListener(this);
